...
class IMDWeatherClient:
    ...
    def find_city(self, city_name: str, exact_match: bool = False) -> List[CityInfo]:
        ...
        for city in cities:
            ...
            if exact_match:
                ...
                if (search_term in city_display or 
                    search_term in city_clean or
                    city_display.startswith(search_term) or 
                    city_clean.startswith(search_term)):
                    matches.append(city)
    ...
    def get_complete_weather_data(self, city_identifier: Union[int, str]) -> tuple[WeatherData, ForecastData]:
        """
    ...
    def _resolve_city_id(self, city_identifier: Union[int, str]) -> int:
        ...
        match_names = [city.display_name for city in matches[:5]]  # Show first 5 matches
