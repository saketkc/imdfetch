...
def search_cities(client: IMDWeatherClient, city_name: str, exact: bool = False) -> None:
...
def get_weather(client: IMDWeatherClient, city_identifier: str, output_format: str = "text") -> None:
...
def get_forecast(client: IMDWeatherClient, city_identifier: str, days: int = 7, output_format: str = "text") -> None:
...
Examples:
  ...
  imd-weather cities --limit 10
    ...
    parser.add_argument('--test', action='store_true',
                       help='Use test endpoint (if available)')
