...
from .utils import clean_parameter_name, clean_city_name, parse_date, convert_date_to_iso
    ...
    def parse_past_24_hours(html_content: str) -> WeatherData:
        ...
        try:
            ...
            for row in rows:
                ...
                if "Past 24 Hours Weather Data" in param_text or not param_text or not value_text:
                    continue
                
                clean_param = clean_parameter_name(param_text)
                parameters.append(WeatherParameter(
    ...
    def parse_forecast_table(html_content: str) -> ForecastData:
        ...
        try:
            ...
            for i, row in enumerate(rows):
                ...
                if "Date" in row_text and ("Min Temp" in row_text or "Max Temp" in row_text):
                    header_row = i
                    break
